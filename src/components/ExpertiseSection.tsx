  ...
  return (
    <section id="expertise" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <h2 className="text-center text-3xl md:text-4xl font-serif mb-3 uppercase">Our Expertise</h2>
        </ScrollReveal>
        <ScrollReveal delay={100}>
          <p className="text-center text-lg text-gray-600 mb-12 uppercase">Transforming Spaces, Enhancing Lives</p>
        </ScrollReveal>
          ...
          {expertiseCards.map((card, index) => (
            ...
            >
              ...
              <div className="expertise-card-content">
                <h3 className="text-white text-xl font-serif mb-2 uppercase">{card.title}</h3>
